...
public class BuildingServiceIMPL implements IBuildingService {
	...
	private BuildingRepositoryCustom buildingCustom = new BuildingRepositoryIMPL();
	...
	public List<BuildingDTO> getBuildings(BuildingDTO buildingDTO) {
		...
		List<BuildingEntity> buildingEntities = buildingCustom.getBuildings(buildingSearchBuilder);
	...
	public List<BuildingDTO> getBuildings(Map<String, String> requestParams, String[] type) {
		...
		List<BuildingEntity> listBuildingEntitie = buildingCustom.getBuildings(builder);
