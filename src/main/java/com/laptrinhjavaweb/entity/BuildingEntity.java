...
public class BuildingEntity extends BaseEntity {
	...
	private static final long serialVersionUID = 3586995294152047157L;
	...
	public List<RentAreaEntity> getRentAres() {
		return rentAres;
	}

	public void setRentAres(List<RentAreaEntity> rentAres) {
		this.rentAres = rentAres;
	}
